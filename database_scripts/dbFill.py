...
def main(argv):
    ...
    for i in range(userCount):
        ...
        x = randint(0,99)
        y = randint(0,99)
        params = urllib.parse.urlencode({'first_name': firstNames[x], 'last_name': lastNames[y], 'email': firstNames[x] + "@" + lastNames[y] + ".com", 'phone': randint(0,9999999999), 'password': "test"})
